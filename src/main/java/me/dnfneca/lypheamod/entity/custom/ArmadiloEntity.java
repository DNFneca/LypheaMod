...
public class ArmadiloEntity extends AnimalEntity {
	...
	public ArmadiloEntity(EntityType<? extends AnimalEntity> entityType, World world) {
...
//            this.getDataTracker().get(TrackedData)
	...
	public PassiveEntity createChild(ServerWorld world, PassiveEntity entity) {
		return ModEntities.ARMADILO.create(world);
	}
