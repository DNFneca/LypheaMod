package me.dnfneca.lypheamod.block.custom;

import me.dnfneca.lypheamod.block.entity.GemPolishingStationBlockEntity;
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if (state.getBlock() != newState.getBlock()) {
            ...
            if (blockEntity instanceof GemPolishingStationBlockEntity) {
                ItemScatterer.spawn(world, pos, ((GemPolishingStationBlockEntity)blockEntity).getItems());
