package me.dnfneca.lypheamod.block;

import me.dnfneca.lypheamod.LypheaMod;
import me.dnfneca.lypheamod.block.custom.*;
import me.dnfneca.lypheamod.sound.ModSounds;
import me.dnfneca.lypheamod.world.tree.ModSaplingGenerators;
...
public class ModBlocks {
    ...
    public static final Block TOMATO_CROP = Registry.register(Registries.BLOCK, new Identifier(LypheaMod.MOD_ID, "tomato_crop"),
            new TomatoCropBlock(FabricBlockSettings.copyOf(Blocks.WHEAT)));

    public static final Block CORN_CROP = Registry.register(Registries.BLOCK, new Identifier(LypheaMod.MOD_ID, "corn_crop"),
    ...
    public static final Block POTTED_DAHLIA = Registry.register(Registries.BLOCK, new Identifier(LypheaMod.MOD_ID, "potted_dahlia"),
    ...
    public static final Identifier CHESTNUT_SIGN_TEXTURE = new Identifier(LypheaMod.MOD_ID, "entity/signs/chestnut");
    public static final Identifier CHESTNUT_HANGING_SIGN_TEXTURE = new Identifier(LypheaMod.MOD_ID, "entity/signs/hanging/chestnut");
    public static final Identifier CHESTNUT_HANGING_GUI_SIGN_TEXTURE = new Identifier(LypheaMod.MOD_ID, "textures/gui/hanging_signs/chestnut");

    public static final Block STANDING_CHESTNUT_SIGN = Registry.register(Registries.BLOCK, new Identifier(LypheaMod.MOD_ID, "chestnut_standing_sign"),
            new TerraformSignBlock(CHESTNUT_SIGN_TEXTURE, FabricBlockSettings.copyOf(Blocks.OAK_SIGN)));
    public static final Block WALL_CHESTNUT_SIGN = Registry.register(Registries.BLOCK, new Identifier(LypheaMod.MOD_ID, "chestnut_wall_sign"),
            new TerraformWallSignBlock(CHESTNUT_SIGN_TEXTURE, FabricBlockSettings.copyOf(Blocks.OAK_WALL_SIGN)));
    public static final Block HANGING_CHESTNUT_SIGN = Registry.register(Registries.BLOCK, new Identifier(LypheaMod.MOD_ID, "chestnut_hanging_sign"),
    ...
    public static final Block WALL_HANGING_CHESTNUT_SIGN = Registry.register(Registries.BLOCK, new Identifier(LypheaMod.MOD_ID, "chestnut_wall_hanging_sign"),
    ...
    public static final Block DICE_BLOCK = Registry.register(Registries.BLOCK, new Identifier(LypheaMod.MOD_ID, "dice_block"),
    ...
    private static Block registerBlock(String name, Block block) {
        ...
        return Registry.register(Registries.BLOCK, new Identifier(LypheaMod.MOD_ID, name), block);
    }

    private static Item registerBlockItem(String name, Block block) {
        return Registry.register(Registries.ITEM, new Identifier(LypheaMod.MOD_ID, name),
                new BlockItem(block, new FabricItemSettings()));
    }

    public static void registerModBlocks() {
        LypheaMod.LOGGER.info("Registering ModBlocks for " + LypheaMod.MOD_ID);
    }
}
