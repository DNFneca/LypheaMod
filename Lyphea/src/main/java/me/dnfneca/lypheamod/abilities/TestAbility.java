...
class TestAbility extends HomingSpell {
    TestAbility(ServerPlayerEntity abilityThrower) {
        super(getLocation(abilityThrower), abilityThrower, new double[]{1, 1, 1}, 1, 2, "10", 30, "test");
